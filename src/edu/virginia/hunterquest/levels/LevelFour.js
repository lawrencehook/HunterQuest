...
class LevelFour extends Level {
	...
	initialize() {
		...
		var bigMonster = new Monster("enemy1", "monster/simon.png", null, game.gamescreen, 100)
		...
		var bigMonster2 = new Monster("enemy1", "monster/simon.png", null, game.gamescreen, 100)
